...
describe('RegisterForm', () => {
  it('should render the registration form correctly', () => {
    ...
    expect(screen.getByText('Create an account', { selector: '[data-slot="card-title"]', exact: true })).toBeInTheDocument();
  ...
  it('should display a general error message if registration fails', () => {
    ...
    expect(screen.getByText('Registration Failed', { selector: '[data-slot="alert-title"]', exact: true })).toBeInTheDocument();
