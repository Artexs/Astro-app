...
describe('ResetPasswordForm', () => {
  it('should render the reset password form correctly', () => {
    ...
    expect(screen.getByText('Reset Password', { selector: '[data-slot="card-title"]', exact: true })).toBeInTheDocument();
  ...
  it('should update password fields on input change and enable button', () => {
    ...
    mockUseResetPassword('newpassword123', 'newpassword123', false, '', {}, vi.fn(), setPasswordMock, setConfirmPasswordMock);
